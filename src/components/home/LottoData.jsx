...
const LottoData = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await axios.get('http://lottouserapp-env.eba-ukcpvyt8.ap-southeast-2.elasticbeanstalk.com/user/fetch');
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const response = await axios.get(`http://lottouserapp-env.eba-ukcpvyt8.ap-southeast-2.elasticbeanstalk.com/user/customfetch?lottery=${selectedLottery}&expShares=${selectedShares}`);
